"""
Django settings for astrasoft project.
...
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD")  # Use Gmail App Password, not your Gmail password!
...
SECRET_KEY = 'django-insecure-bu1efi0+$frv%ml&tbn7(h=xm%g7utgne#tj!4a#n9vuh!=*r4'
...
WSGI_APPLICATION = 'astrasoft.wsgi.application'
...
# These are only for dev (optional)
STATICFILES_DIRS = [
