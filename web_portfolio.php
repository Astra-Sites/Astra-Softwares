...
$baseDir = __DIR__;
$imageFolder = $baseDir . '/static/assets/img/carousel/web';
...
if (file_exists($imageFolder)) {
    ...
    foreach ($allFiles as $file) {
        ...
        if (in_array(pathinfo($file, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif'])) {
            $imageFiles[] = "static/assets/img/carousel/web/" . $file; // Relative path from 'static'
        }
    }
}
...
<div class="hero d-flex align-items-center justify-content-center text-center bg-dark text-white position-relative" style="min-height: 350px;">
  ...
  <div class="hero-content position-relative z-2">
    <h1 class="display-4 fw-bold mb-3" style="text-shadow: 0 2px 8px #000;">Our Web Portfolio</h1>
    <p class="lead" style="text-shadow: 0 1px 4px #000;">Explore our Website Portfolio collection.</p>
  </div>
</div>
<!-- end hero -->
