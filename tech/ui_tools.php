...
$imageFolder =  '../static/assets/img/logos/ui-tools/';
...
if (is_dir($imageFolder)) {
    ...
    foreach ($allFiles as $file) {
        ...
        if (in_array($ext, ['jpg','#.jpg', 'jpeg', 'png', 'gif', 'svg'])) {
            $imageFiles[] = "../static/assets/img/logos/ui-tools/" . $file;
        }
    }
}
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                <h1 class="display-2 mb-3">Our UI/UX Stack</h1>
                <p>The UI/UX Platforms & Tools Powering Astra Softwares</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section py-5">
    <div class="container">
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-md-8 text-center">
                <h2 class="display-4 mb-3">UI/UX Design Tools & Technologies</h2>
                <p>Explore the core tools powering our UI/UX design solutions.</p>
            </div>
        </div>
