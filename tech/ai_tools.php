<?php
    $pageTitle  = "Astra Softwares | Our Artificial Inteligence Stack";
...
$imageFolder =  '../static/assets/img/logos/ai-tools/';
...
if (is_dir($imageFolder)) {
    ...
    foreach ($allFiles as $file) {
        ...
        if (in_array($ext, ['jpg','#.jpg', 'jpeg', 'png', 'gif', 'svg'])) {
            $imageFiles[] = "../static/assets/img/logos/ai-tools/" . $file;
        }
    }
}
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                <h1 class="display-2 mb-3">Our AI Stack</h1>
                <p>The Technologies and Platforms Powering Our AI Solutions</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section py-5">
    <div class="container">
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-md-8 text-center">
                <h2 class="display-4 mb-3">AI Platforms & Technologies</h2>
                <p>Discover the platforms and technologies that power our AI solutions.</p>
            </div>
        </div>
