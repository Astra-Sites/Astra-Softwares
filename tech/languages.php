...
if (is_dir($imageFolder)) {
    ...
    foreach ($allFiles as $file) {
        ...
        if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif', 'svg'])) {
            $imageFiles[] = "../static/assets/img/logos/languages/" . $file;
        }
    }
}
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                <h1 class="display-2 mb-3">Our Tech Stack</h1>
                <p>The Languages and Tools Powering Astra Softwares</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section py-5">
    <div class="container">
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-md-8 text-center">
                <h2 class="display-4 mb-3">Programming Languages & Frameworks</h2>
                <p>Explore the core languages powering our solutions.</p>
            </div>
        </div>
