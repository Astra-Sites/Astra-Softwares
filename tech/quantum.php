...
<?php
    $pageTitle  = "Astra Softwares | Our Quantum Computing  Stack";
...
$imageFolder =  '../static/assets/img/logos/quantum/';
...
if (is_dir($imageFolder)) {
    ...
    foreach ($allFiles as $file) {
        ...
        if (in_array($ext, ['jpg','#.jpg', 'jpeg', 'png', 'gif', 'svg'])) {
            $imageFiles[] = "../static/assets/img/logos/quantum/" . $file;
        }
    }
}
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                <h1 class="display-2 mb-3">Our Quantum ML Stack</h1>
                <p>The Technologies and Platforms Powering Our Quantum ML Solutions</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section py-5">
    <div class="container">
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-md-8 text-center">
                <h2 class="display-4 mb-3">Quantum ML Platforms & Technologies</h2>
                <p>Discover the platforms and technologies that power our quantum ML solutions.</p>
            </div>
        </div>
