...
$imageFolder =  '../static/assets/img/logos/databases/';
...
if (is_dir($imageFolder)) {
    ...
    foreach ($allFiles as $file) {
        ...
        if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif', 'svg'])) {
            $imageFiles[] = "../static/assets/img/logos/databases/" . $file;
        }
    }
}
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                <h1 class="display-2 mb-3">Our Database Stack</h1>
                <p>The Technologies and Platforms Powering Our Database Solutions</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section py-5">
    <div class="container">
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-md-8 text-center">
                <h2 class="display-4 mb-3">Database Platforms & Technologies</h2>
                <p>Discover the platforms and technologies that power our database solutions.</p>
            </div>
        </div>
